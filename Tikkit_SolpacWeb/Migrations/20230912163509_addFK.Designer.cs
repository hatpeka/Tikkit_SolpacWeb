...
namespace Tikkit_SolpacWeb.Migrations
{
    ...
    [Migration("20230912163509_addFK")]
    partial class addFK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tikkit_SolpacWeb.Models.Requests", b =>
                {
                    ...
                    b.Property<string>("RequestPersonName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Tikkit_SolpacWeb.Models.Notification", b =>
                {
                    b.HasOne("Tikkit_SolpacWeb.Models.Requests", "Request")
                        .WithMany()
                        .HasForeignKey("RequestID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tikkit_SolpacWeb.Models.Users", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Tikkit_SolpacWeb.Models.Requests", b =>
                {
                    b.HasOne("Tikkit_SolpacWeb.Models.Users", "RequestPerson")
                        .WithMany()
                        .HasForeignKey("RequestPersonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tikkit_SolpacWeb.Models.Users", "Supporter")
                        .WithMany()
